...
import "./SemesterPage2.css";  // same CSS file use kar sakte ho jo maine pehle diya tha

function SemesterPage2() {
  return (
    <div className="semester-page">
      <h1>📖 2nd Semester</h1>
      <p>Welcome to the 2nd Semester resources page</p>
