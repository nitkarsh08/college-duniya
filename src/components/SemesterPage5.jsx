...
import "./SemesterPage5.css";  // same CSS file use kar sakte ho jo maine pehle diya tha

function SemesterPage5() {
  return (
    <div className="semester-page">
      <h1>📖 5th Semester</h1>
      <p>Welcome to the 5th Semester resources page</p>
      ...
      <div className="sections">
        ...
        <div className="section-card">
          ...
          <a
            href="/public/cse syllabus-55-70.pdf"
            className="btn"
            target="_blank"
