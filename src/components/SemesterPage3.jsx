...
import "./SemesterPage3.css";  // same CSS file use kar sakte ho jo maine pehle diya tha

function SemesterPage3() {
  return (
    <div className="semester-page">
      <h1>📖 3rd Semester</h1>
      <p>Welcome to the 3rd Semester resources page</p>
      ...
      <div className="sections">
        ...
        <div className="section-card">
          ...
          <a
            href="/public/cse syllabus-27-39.pdf"
            className="btn"
            target="_blank"
