...
import "./SemesterPage6.css";  // same CSS file use kar sakte ho jo maine pehle diya tha

function SemesterPage6() {
  return (
    <div className="semester-page">
      <h1>📖 6th Semester</h1>
      <p>Welcome to the 6th Semester resources page</p>
      ...
      <div className="sections">
        ...
        <div className="section-card">
          ...
          <a
            href="/public/cse syllabus-71-87.pdf"
            className="btn"
            target="_blank"
